...
; AVX-NEXT:    vpcmpeqd %xmm0, %xmm0, %xmm0
; AVX-NEXT:    ret{{[l|q]}}
  ret <4 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>
}
...
; AVX256-NEXT:    vpcmpeqd %ymm0, %ymm0, %ymm0
; AVX256-NEXT:    ret{{[l|q]}}
  ret <8 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>
}
...
; AVX512-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0
; AVX512-NEXT:    ret{{[l|q]}}
  ret <16 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>
}
