...
; X64-NEXT:    vzeroupper
; X64-NEXT:    retq
  %3 = tail call <4 x float> @llvm.x86.avx2.gather.q.ps.256(<4 x float> zeroinitializer, ptr @x, <4 x i64> %0, <4 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>, i8 4)
  ret <4 x float> %3
}
