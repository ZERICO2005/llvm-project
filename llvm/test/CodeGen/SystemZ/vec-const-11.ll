...
; CHECK: br %r14
  ret <4 x float> <float -nan(0x3FFFFF), float 0xfffff00000000000,
                   float -nan(0x3FFFFF), float 0xfffff00000000000>
}
...
; CHECK-NOT: vrepig
; CHECK: br %r14
  ret <4 x float> <float -nan(0x3FFFFF), float 0xffffefffe0000000,
                   float -nan(0x3FFFFF), float 0xffffefffe0000000>
}
...
; CHECK: vrepig %v24, -2
; CHECK: br %r14
  ret <4 x float> <float -nan(0x3FFFFF), float 0xffffffffc0000000,
                   float -nan(0x3FFFFF), float 0xffffffffc0000000>
}
...
; CHECK: vrepig %v24, -2
; CHECK: br %r14
  ret <4 x float> <float -nan(0x3FFFFF), float undef,
