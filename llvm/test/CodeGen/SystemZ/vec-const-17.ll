...
; CHECK: vgmg %v24, 0, 44
; CHECK: br %r14
  ret <4 x float> <float -nan(0x3FFFFF), float 0xffff000000000000,
                   float -nan(0x3FFFFF), float 0xffff000000000000>
}
...
; CHECK: vgmg %v24, 32, 0
; CHECK: br %r14
  ret <4 x float> <float 0x8000000000000000, float -nan(0x3FFFFF),
                   float 0x8000000000000000, float -nan(0x3FFFFF)>
}
