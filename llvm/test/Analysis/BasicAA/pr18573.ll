...
allocas:
  ...
  %v1 = tail call <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> undef, ptr %arr.ptr, <8 x i32> %vix, <8 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>, i8 1) #2
  store i8 1, ptr %t1.ptr, align 4

  %v2 = tail call <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> undef, ptr %arr.ptr, <8 x i32> %vix, <8 x float> <float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF), float -nan(0x3FFFFF)>, i8 1) #2
