...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 [[ARG1]]) #[[ATTR11:[0-9]+]]
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(psub) float @llvm.ldexp.f32.i32(float nofpclass(psub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nsub) float @llvm.ldexp.f32.i32(float nofpclass(nsub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) float @llvm.ldexp.f32.i32(float nofpclass(sub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(snan sub) float @llvm.ldexp.f32.i32(float nofpclass(snan sub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pzero psub) float @llvm.ldexp.f32.i32(float nofpclass(pzero psub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nzero nsub) float @llvm.ldexp.f32.i32(float nofpclass(nzero nsub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(zero sub) float @llvm.ldexp.f32.i32(float nofpclass(zero sub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nzero psub) float @llvm.ldexp.f32.i32(float nofpclass(zero psub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pzero psub) float @llvm.ldexp.f32.i32(float nofpclass(zero psub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(psub) float @llvm.ldexp.f32.i32(float nofpclass(zero psub) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pnorm) float @llvm.ldexp.f32.i32(float nofpclass(pnorm) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nnorm) float @llvm.ldexp.f32.i32(float nofpclass(nnorm) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nsub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(nsub pnorm) [[ARG0]], i32 noundef 0) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 0)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call <2 x float> @llvm.ldexp.v2f32.v2i32(<2 x float> [[ARG0]], <2 x i32> <i32 undef, i32 0>) #[[ATTR11]]
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i64(float [[ARG0]], i64 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call <2 x float> @llvm.ldexp.v2f32.v2i32(<2 x float> [[ARG0]], <2 x i32> [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret <2 x float> [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nan) float @llvm.ldexp.f32.i32(float nofpclass(nan) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(snan) float @llvm.ldexp.f32.i32(float nofpclass(snan) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(qnan) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(ninf nsub nnorm) float @llvm.ldexp.f32.i32(float nofpclass(ninf nsub nnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(ninf nzero nsub nnorm) float @llvm.ldexp.f32.i32(float nofpclass(ninf nzero nsub nnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(nzero) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(pzero) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(ninf nnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf psub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(pinf psub pnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf pzero psub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(pinf pzero psub pnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf pzero psub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(pinf zero psub pnorm) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(zero) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(inf) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nan) float @llvm.ldexp.f32.i32(float nofpclass(nan inf) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) float @llvm.ldexp.f32.i32(float nofpclass(sub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(sub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(sub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(psub) float @llvm.ldexp.f32.i32(float nofpclass(psub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(psub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(psub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nsub) float @llvm.ldexp.f32.i32(float nofpclass(nsub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(nsub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(nsub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-SAME: (float nofpclass(inf) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(inf) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(inf) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(inf) float @llvm.ldexp.f32.i32(float nofpclass(inf) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[CALL:%.*]] = call <2 x float> @llvm.ldexp.v2f32.v2i32(<2 x float> nofpclass(inf) [[ARG0]], <2 x i32> [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret <2 x float> [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(inf) <2 x float> @llvm.ldexp.v2f32.v2i32(<2 x float> nofpclass(inf) [[ARG0]], <2 x i32> [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret <2 x float> [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call <2 x float> @llvm.ldexp.v2f32.v2i32(<2 x float> nofpclass(inf) [[ARG0]], <2 x i32> [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret <2 x float> [[CALL]]
;
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(pinf) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(pinf) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf) float @llvm.ldexp.f32.i32(float nofpclass(pinf) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(ninf) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(ninf) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(ninf) float @llvm.ldexp.f32.i32(float nofpclass(ninf) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pzero psub) float @llvm.ldexp.f32.i32(float nofpclass(pzero psub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(pzero psub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR2]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(pzero psub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nzero nsub) float @llvm.ldexp.f32.i32(float nofpclass(nzero nsub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(nzero nsub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR2]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(nzero nsub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-NEXT:    [[AND_ARG1:%.*]] = and i32 [[ARG1]], 127
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(zero sub) float @llvm.ldexp.f32.i32(float nofpclass(zero sub) [[ARG0]], i32 [[AND_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %and.arg1 = and i32 %arg1, 127
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %and.arg1)
...
; CHECK-SAME: (float nofpclass(zero sub) [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR2]] {
; CHECK-NEXT:    [[OR_ARG1:%.*]] = or i32 [[ARG1]], -16
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float nofpclass(zero sub) [[ARG0]], i32 [[OR_ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %or.arg1 = or i32 %arg1, -16
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %or.arg1)
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef 22) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef 23) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef 24) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-SAME: (float [[ARG0:%.*]], i32 [[ARG1:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[MIN:%.*]] = call i32 @llvm.smin.i32(i32 [[ARG1]], i32 noundef 24) #[[ATTR11]]
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 [[MIN]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nan sub) float @llvm.ldexp.f32.i32(float nofpclass(nan) [[ARG0]], i32 noundef 23) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 23)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call double @llvm.ldexp.f64.i32(double [[ARG0]], i32 noundef 24) #[[ATTR11]]
...
; CHECK-SAME: (double [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call double @llvm.ldexp.f64.i32(double [[ARG0]], i32 noundef 51) #[[ATTR11]]
; CHECK-NEXT:    ret double [[CALL]]
;
...
; CHECK-SAME: (double [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) double @llvm.ldexp.f64.i32(double [[ARG0]], i32 noundef 52) #[[ATTR11]]
; CHECK-NEXT:    ret double [[CALL]]
;
...
; CHECK-SAME: (double [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) double @llvm.ldexp.f64.i32(double [[ARG0]], i32 noundef 53) #[[ATTR11]]
; CHECK-NEXT:    ret double [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call half @llvm.ldexp.f16.i32(half [[ARG0]], i32 noundef 8) #[[ATTR11]]
...
; CHECK-SAME: (half [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call half @llvm.ldexp.f16.i32(half [[ARG0]], i32 noundef 9) #[[ATTR11]]
; CHECK-NEXT:    ret half [[CALL]]
;
...
; CHECK-SAME: (half [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) half @llvm.ldexp.f16.i32(half [[ARG0]], i32 noundef 10) #[[ATTR11]]
; CHECK-NEXT:    ret half [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call bfloat @llvm.ldexp.bf16.i32(bfloat [[ARG0]], i32 noundef 6) #[[ATTR11]]
...
; CHECK-SAME: (bfloat [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) bfloat @llvm.ldexp.bf16.i32(bfloat [[ARG0]], i32 noundef 7) #[[ATTR11]]
; CHECK-NEXT:    ret bfloat [[CALL]]
;
...
; CHECK-SAME: (bfloat [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(sub) bfloat @llvm.ldexp.bf16.i32(bfloat [[ARG0]], i32 noundef 8) #[[ATTR11]]
; CHECK-NEXT:    ret bfloat [[CALL]]
;
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef -23) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 -23)
  ret float %call
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef -24) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 -24)
  ret float %call
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef -126) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-SAME: (float [[ARG0:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    [[CALL:%.*]] = call float @llvm.ldexp.f32.i32(float [[ARG0]], i32 noundef -127) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(inf) float @llvm.ldexp.f32.i32(float nofpclass(inf) [[ARG0]], i32 [[ARG1]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %arg1)
  ret float %call
...
; ruled out.
define float @ret_ldexp_negnormal_or_negsubnormal_mode_dynamic_dynamic(float nofpclass(nan inf zero psub pnorm) %arg0, i32 %exp) #9 {
; CHECK-LABEL: define nofpclass(nan pinf pzero psub pnorm) float @ret_ldexp_negnormal_or_negsubnormal_mode_dynamic_dynamic
; CHECK-SAME: (float nofpclass(nan inf zero psub pnorm) [[ARG0:%.*]], i32 [[EXP:%.*]]) #[[ATTR10:[0-9]+]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nan pinf pzero psub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(nan inf zero psub pnorm) [[ARG0]], i32 [[EXP]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %exp)
  ret float %call
}

; TODO: A negative subnormal input may be flushed to +0.0, so +0.0 must not be
; ruled out.
define float @ret_ldexp_negnormal_or_negsubnormal_mode_ftpz_dapz(float nofpclass(nan inf zero psub pnorm) %arg0, i32 %exp) #2 {
; CHECK-LABEL: define nofpclass(nan pinf pzero psub pnorm) float @ret_ldexp_negnormal_or_negsubnormal_mode_ftpz_dapz
; CHECK-SAME: (float nofpclass(nan inf zero psub pnorm) [[ARG0:%.*]], i32 [[EXP:%.*]]) #[[ATTR3]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nan pinf pzero psub pnorm) float @llvm.ldexp.f32.i32(float nofpclass(nan inf zero psub pnorm) [[ARG0]], i32 [[EXP]]) #[[ATTR11]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.ldexp.f32.i32(float %arg0, i32 %exp)
...
attributes #9 = { denormal_fpenv(dynamic|dynamic) }
