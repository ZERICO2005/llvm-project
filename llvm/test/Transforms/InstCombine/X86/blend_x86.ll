...
;
  %1 = tail call <4 x float> @llvm.x86.sse41.blendvps(<4 x float> %xyzw, <4 x float> %abcd, <4 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float -nan(0x3FFFFF)>)
  ret <4 x float> %1
}
...
;
  %1 = tail call <8 x float> @llvm.x86.avx.blendv.ps.256(<8 x float> %xyzw, <8 x float> %abcd, <8 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float -nan(0x3FFFFF), float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float -nan(0x3FFFFF)>)
  ret <8 x float> %1
}
